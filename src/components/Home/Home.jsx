        ...
        <div className='my-container flex flex-col items-center justify-between lg:flex-row'>
            ...
            <div className='mb-10 lg:max-w-lg lg:pr-5 lg:mb-0'>
                <div className='max-w-xl mb-6 lg:mt-8'>
                    ...
                    <h2 className='max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none'>A reader lives a <br className='hidden md:block'/> thousand lives {' '} <span className='inline-block text-blue-400'>before he dies</span></h2>
